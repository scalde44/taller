...
public class ValidadorArgumento {
	...
	public static void validarFechaEntreHoras(LocalDateTime fechaInicial, int horaInicial, int horaFinal,
			String mensaje) {
		if (fechaInicial.getHour() < horaInicial || fechaInicial.getHour() >= horaFinal) {
			throw new ExcepcionValorInvalido(mensaje);
		}
	}
